...
- React Native 0.60+
    ...
    2. Add VIForegroundService as a service to the application's `AndroidManifest.xml`:
        ```
        <service android:name="com.softmills.foregroundservice.VIForegroundService"> </service>
...
1. Open up `android/app/src/main/java/[...]/MainActivity.java`
    - Add `import com.softmills.foregroundservice.VIForegroundServicePackage;` to the imports at the top of the file
